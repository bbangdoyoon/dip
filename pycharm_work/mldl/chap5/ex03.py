import numpy as np
import pandas as pd                                      # pandas library 가져옴
...
# print(x)
# plt.scatter(x[:, 1], x[:, 0])
# plt.show()                                             # 4197개의 점이 찍힘, 당도가 1인 data와 당도가 0에 가까운 data 표현
...
print(테스트점수)
'''0 데이터..'''
#pred = dt.predict([[9.4, 1.9, 3.51], [9.3, 1.70, 3.50]]) # 앞의 []는 0, 뒤의 []는 임의로 만든 값
...
dt = gridcv.best_estimator_                     # 학습기중에 최고 성능을 나타낸 학습기 가지고 와라
