...
train_input, test_input, train_target, test_target = train_test_split(wine_data, wine_class, test_size=0.2, random_state=42)
...
train_scaled = ss.transform(train_input)        # x1 data
test_scaled = ss.transform(test_input)          # x2 data
