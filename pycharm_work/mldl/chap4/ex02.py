...
sgd = SGDClassifier(loss='log', max_iter=100, random_state=42)    #stochastic'은 학습과정에서의 random behavior를 의미
sgd.fit(train_scaled, train_target)                #SGD는 각 training data에 대해 error를 계산한 뒤, weights를 즉시 조정
...
for _ in range(300):                    # for문의 _는 python문법 쓰지않는 i는 _로 표시가능
